 ...
 * @format
 */
export declare type GraphRequestCallback = (error?: Record<string, unknown>, result?: Record<string, unknown>) => void;
export declare type GraphRequestConfig = {
    /**
...
export declare type GraphRequestParameters = {
    [key: string]: unknown;
};
/**
